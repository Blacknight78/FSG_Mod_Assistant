	...
	load : () => {
		...
		try {
			...
			serveIPC.modCollect.modHubList = {
				games : {
					22 : { mods : jsonData22.mods, last : jsonData22.recent },
					25 : { mods : jsonData25.mods, last : jsonData25.recent },
				},
				last   : [...jsonData22.recent, ...jsonData25.recent],
				legacy : oldModHub.mods,
				mods   : { ...oldModHub.mods, ...jsonData22.mods, ...jsonData25.mods},
			}
			serveIPC.modCollect.modHubVersion = {
				...oldModHub.versions,
				...jsonData22.version,
				...jsonData25.version,
				games : {
					22 : jsonData22.version,
					25 : jsonData25.version,
				},
				legacy : oldModHub.versions,
			}
