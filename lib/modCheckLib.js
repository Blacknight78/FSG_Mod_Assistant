...
class modFileCollection {
	...
	modHubMatchShortName(shortName, savedIDsByNormalizedName = null) {
		...
		const savedIDs = savedIDsByNormalizedName instanceof Map ?
			(savedIDsByNormalizedName.get(normalizedName) ?? new Set()) :
			new Set(Object.values(serveIPC.storeLibrary?.get?.('records', {}) ?? {})
