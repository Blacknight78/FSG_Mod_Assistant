...
const allLang         = require('./modLookerLang_22.json')
...
// const { convert_dds } = require('neon-dds-convert')
...
class modLooker {
	...
	async #getMapImage(modDescTree) {
		if ( modDescTree !== null ) {
			...
			return this.#loadIcon(mapImageName)
		}
		return null
	}
...
class ddsDecoder {
	...
	async parseDDS(_fileBuffer) {

		// try {
		// return convert_dds(fileBuffer, 1024)
		// } catch (err) {
		throw new Error('DDS Decode Error: null code point')
		// }
	}
}
